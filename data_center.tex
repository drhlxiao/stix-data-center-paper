...
\begin{itemize}
  ...
  The browser greatly reduces the barrier to explore STIX data for new comers. It is also facilitated
  for  experience user. 
  \item  Preview images and spectroscopy product browser. 
  Performing spectrocopy and imaging with STIX data requires various inp.t
...
Caching, blance and preprocessing
