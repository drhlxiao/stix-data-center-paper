...
\begin{figure*}
  ...
  Pixels 0 -- 3 are the top big pixels, Pixels 4 -- 7 are the bottom pixels and 8 -- 11 the small pixels as shown in the right panel.
   ...
   The best-fit centroid location is obtained at (550, 278) arcsec (marked by x).  Its 1$\sigma$, 2$\sigma$ and 3$\sigma$ confidence contours  are shown.
...
\begin{itemize}
  ...
  (i.e. chi-squared) between  the calculated illuminated areas and  expectations
...
of the CFL pixels measure observed for STIX flare 2105071900, the middle panel shows the best-fit 
