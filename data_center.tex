...
STIX uses a software package based on SSWIDL's OSPEX\fotenote{https://hesperia.gsfc.nasa.gov/ssw/packages/spex/doc/} for spectral analysis(\cite{andrea2021}).
