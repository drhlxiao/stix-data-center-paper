...
\begin{figure*}
  ...
  Pixels 0 -- 3 are the top big pixels, Pixels 4 -- 7 are the bottom pixels and 8 -- 11 the small pixels.
   ...
   The best fit centroid location is obtained at (550, 278) arcsec (marked by x).  Its 1$\sigma$, 2$\sigma$ and 3$\sigma$ confidence contours  are shown.
    Right: 
  Shadow (the grey shaded regions) of CFL sub-collimator on the detector 
