...
for example, 
\begin{itemize}
  \item Raw file metadata, which contains filename, reception time, observation start time and stop time, MIB and SPICE kernels used by the parser ; 
  ...
  \item Quick-look data, containing  QL data type, observation time range, and array of counts or energies depending on the packet type;
  \item STIX instrument configuration data, which is extracted from telemecommands, allowing tracking back of the instrument configuration;
\end{itemize}
