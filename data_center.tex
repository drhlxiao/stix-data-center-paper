...
\begin{figure*}
  ...
  \caption{Left: simulated shadow pattern (the grey shaded regions) of CFL sub-collimator on STIX detector 
  for STIX flare 2105071900. 
   Middle: Area of illuminated regions of 12 pixels calculated by combining
  the twelve pixels counts with averages from other detectors, and the best fit.
   ...
   The best fit is obtained at (550, 278) arcsecdGFAGGGGGGGGGG
...
\begin{itemize}
  ...
  \item Calculation of illuminated area of CFL pixel $s_i = c/F$  
  %%\item 
\end{itemize}
