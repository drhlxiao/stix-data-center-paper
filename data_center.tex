...
% 5 {} token are mandatory
  ...
  % context heading (optional)
   ...
   of the ten instruments onboard the Solar Orbiter.  It is capable of measuring spectra and taking images of X-rays in the energy range of 4 to 150 keV with 1 keV resolution.   } %leave it empty if necessary  
  % {context.}
