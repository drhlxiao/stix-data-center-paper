...
compiled and serialized data  to the web browser. 
Then the data are parsed, and used to  create interactive light curve plot on the client side by using JavaScript.
Thanks to the use of modern web technologies, the interactive plot allows users  
...
can be also displayed on the same page.

Based on the same concept, we have developed web applications to 
browser housekeeping data, ephemeris data, calibration data,  
and different types of science data. They
