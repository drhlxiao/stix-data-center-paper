...
STIX uses a software package based on SSWIDL's OSPEX\fotenote{\href {https://hesperia.gsfc.nasa.gov/ssw/packages/spex/doc/}} for spectral analysis(\cite{andrea2021}).
...
It will be integrated into the flaring data processing pipeline and used for creation of
 spectral analysis products.
\subsubsection{Flare imaging}
STIX images at different photon energy ranges can be reconstructed by means of algorithms 
for the inversion of the Fourier transform from limited data.  
For the details, we refer to the imaging papers () 
For the detailed, please 
