...
STIX uses a software package based on SSWIDL's OSPEX for spectral analysis(\cite{andrea2021}).
The software reads pixel count data from L1 FITS files, performs
...
It will be integrated into the flaring data processing pipeline and used for creation of spectral analysis reports 
