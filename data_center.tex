...
The software reads pixel count data from L1 FITS files, 
corrections for dead time, transmission and energy binning for the counts, and calls 
OSPEX routines for spectral fitting. 
A python version of spectral analysis software is still under development. 
...
STIX images at different photon energy ranges can
 ...
 analysis software. 
 For the details of the algorithms and the package, we refer to the first
  STIX imaging paper (\cite{paolo2020}). 
The software will be integrated into the flaring data processing pipeline to 
create X-ray images and movies in different ranges and time intervals. 
They will be provided to the public as level-4 data products. 
